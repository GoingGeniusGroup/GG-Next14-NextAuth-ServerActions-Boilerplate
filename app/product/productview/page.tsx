            ...
            <div className="container flex flex-col gap-2">
                ...
                <div className='flex justify-center'>
                    {displayCount < products.length && (
                        <button className='bg-blue-500 text-white p-2 rounded-md' onClick={() => setDisplayCount(displayCount + 3)}>Load More</button>
                    )}
                    {displayCount >= products.length && (
                        <button className='bg-blue-500 text-white p-2 rounded-md' onClick={() => setDisplayCount(3)}>Show Less</button>
                    )}
                </div>
            </div>
        </div>
